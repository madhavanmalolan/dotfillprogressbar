...
public class DotProgressIndicator extends View {
    ...
    public DotProgressIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public DotProgressIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    void setFilled(int count){
        filled = count;
        invalidate();
    }

    void setCircles(int totalCircles, int filledCircles){
